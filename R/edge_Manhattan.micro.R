...
#'
#' @description
#' The `edge_Manhattan.micro` function performs pairwise differential abundance analysis using the `edgeR` package.
...
#' @examples
#' \dontrun{
#' res = edge_Manhattan.micro(ps = ps.16s%>% ggClusterNet::filter_OTU_ps(500),pvalue = 0.05,lfc = 0)
#'  }
#'
