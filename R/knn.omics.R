#' @title k-Nearest Neighbors (k-NN) Classification of feature in multi-omics data
#' @description
#' The `knn.omics` function applies the k-Nearest Neighbors (k-NN) algorithm to classify microbial community data.
