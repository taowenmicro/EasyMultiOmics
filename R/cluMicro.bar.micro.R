...
#'   \item{Processed Data}{A data frame with microbial composition data, including relative abundances and taxonomic annotations.}
#' }
#'
#' @details
#' This function:
...
#' @examples
#' \dontrun{
#' result <- cluMicro.bar.micro(dist = "bray", ps = ps.16s, j = "Genus", Top = 10,
