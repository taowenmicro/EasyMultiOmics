...
#'   \item{Processed Data}{A data frame with the processed metabolites composition data.}
...
barMainplot.ms = function(otu = NULL,tax = NULL,map = NULL,tree = NULL ,ps = NULL,group  = "Group",
