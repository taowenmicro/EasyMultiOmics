...
#' @description
#' This function conducts PCA analysis on transcriptome functional composition data to
...
#' res = loadingPCA.trans(ps = ps,Top = 20)
#' p = res[[1]]
#' p
#' dat = res[[2]]
#' dat
...
loadingPCA.trans= function(ps = ps,Top = 20){
  count =ps %>%
