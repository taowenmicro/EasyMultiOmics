#' @title For cross-validation of metagenome functional composition data
#' @description For cross-validation of metagenome functional composition data
...
#' rfcvtable
#'@export
rfcv.metf = function(otu = NULL,tax = NULL,map = NULL,tree = NULL,
