#' @title Differential abundance analysis using t test for transcriptome functional data
#' @description
#' #' This function performs differential abundance analysis for transcriptome functional data using the `t.test` function.
