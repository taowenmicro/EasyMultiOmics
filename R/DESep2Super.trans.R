...
#'
#' @description
#' The \code{DESep2Super.trans} function performs differential abundance analysis between
#' transcriptome functional groups using the \code{DESeq2} package. It identifies
...
#' transcriptome functional composition, taxonomic, and metadata tables.
#'
...
#' @param tax A data frame containing transcriptome functional classification table.
#'   Optional if \code{ps} is provided.
#' @param ps A \code{phyloseq} object used as an alternative for the input containing
#'   transcriptome functional composition table, tax, and sample metadata.
