...
#'
#' @description
#' This function generates a heatmap to visualize microbial abundance across samples.
#' The heatmap includes options for clustering, scaling, and annotations of rows and columns.
#' The data is sourced from a `phyloseq` object.
#'
