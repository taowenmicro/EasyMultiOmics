# -------------------------------------------------------------------
# Public: create metagenome result directory
# -------------------------------------------------------------------

#' Create result directory for metagenome data
#'
#' This function creates a result directory for metagenomic-based analyses.
#' The directory name encodes a prefix (e.g. \code{"metagenome"}), a
...
#' @param prefix Prefix for the folder name (default: \code{"metagenome"}).
...
#' @export
create_metagenome_result_dir <- function(ps,
                                         base_dir     = "./result",
                                         prefix       = "metagenome",
                                         include_time = FALSE) {
  # 1. Build the result folder name based on the date (and optionally time)
  ...
  folder_name <- paste(prefix, datetime_label, sep = "_")
  out_path    <- file.path(base_dir, folder_name)

  # 3. Create directory, prefer user-defined dir_create() if available
...
#' @export
create_omics_result_dir_auto0 <- function(ps,
                                         base_dir          = "./result",
                                         include_time      = FALSE,
