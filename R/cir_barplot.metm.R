...
#' \describe{
#'   \item{Circular Dendrogram with Bar Plots}{A `ggtree` circular dendrogram with bar plots showing relative abundances of taxa.}
#'   \item{Processed Data}{A data frame containing the processed data used for plotting, including taxonomic annotations and abundances.}
#' }
#'
#' @details
