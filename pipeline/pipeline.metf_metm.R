...
#12 heatmap.line.omics


#13  volcano.line.omics


#11


#11 heatmap.line.omics: 分面互连 ----

library(EasyMultiOmics)
my.env()
#微生物热图#---------
res=heatmap.line.omics(ps01=ps.16s,
                       ps02=ps.ms,lab.1 = "micro",
                       lab.2 = "ms")
grid.draw(res[[1]])
res[[2]]
res[[3]]
...
#12 volcano.line2.omics: 火山互连 ----
res= volcano.line2.omics(ps.16s=ps.16s,
                         ps.ms = ps.ms,
                         group1= "micro",
                         group2= "ms",
                         r.threshold = 0.6,
...
ps = ps03 %>% subset_taxa.wt("Family","Unassigned",T)
